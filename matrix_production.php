...
#contact button[type="submit"]:active {
  box-shadow: inset 0 1px 3px rgba(0, 0, 0, 0.5);
    ...
    width: 500px;
    height: 500px;">
							<form id="contact" action="welcome_get.php" method="get">
								<fieldset><input placeholder="Enter Serial Number" type="text" name="S_number"></fieldset>
								<fieldset> <input placeholder="Enter Product Name" type="text" name="product"></fieldset>
								<fieldset><input type="text" placeholder="Enter Quantity" name="qunatity"></fieldset>
								<fieldset> <input type="text" placeholder="Enter Description" name="description"></fieldset>
								<fieldset> <input type="text" placeholder="Enter Warehouse Id" name="wid"></fieldset>
