	...
	<body>
		<div id="perspective" class="perspective effect-airbnb">
            ...
            if ($result->num_rows > 0) {
							echo "<table align='center' style='text-align:center;'><thead style='border: solid 1px #cecccc;background: #a3a9a9;color: white;font-size: 20px;'><tr><th>TRUCK ID</th><th >MAX WEIGHT</th><th >REG_NO</th><th >MODEL</th></tr></thead><tbody style='    border: #cecccc 1px solid;
    background: #f9f9f9;
    font-size: 18px;'>";
							while($row = $result->fetch_assoc()) {
          echo "<tr style='zborder-bottom: solid 1px #bda7a7;box-shadow: 0px 2px 5px 2px #f1f1f1;'><td><span> ". $row["TID"]. "</span></td><td><span> " . $row["MAXWT"]. "</span></td><td><span> " . $row["REG_NO"]."</span></td><td><span> ".$row["MODEL"]."</span></td></tr>";
      }
			echo "</tbody></table>";
  } else {
      echo "0 results";
